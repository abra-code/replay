#!/bin/sh
# makepkg-local.sh - build and sign the replay installer package
#
# Written by PackageBuilder.app from "replay-local.pkgbld" on 2026-09-12.
#
...
verify_entry ''"$artifacts_dir"'/replay' 'x86_64 arm64 ' '' '0' '0' '--version'
verify_entry ''"$artifacts_dir"'/dispatch' 'x86_64 arm64 ' '' '0' '0' '--version'
verify_entry ''"$artifacts_dir"'/fingerprint' 'x86_64 arm64 ' '' '0' '0' '--version'
verify_entry ''"$artifacts_dir"'/gate' 'x86_64 arm64 ' '' '0' '0' '--version'
...
package_name=''"$project_name"'_'"$package_version"'-localtest.pkg'
